...
if ($errors == 0) {
	...
	echo "Your new Intern ID is <strong>" . $_SESSION['internID'] . "</strong>.</p>\n";
}

if ($errors == 0) {
	//echo "<form method='post' " . 	" action='AvailableOpportunities.php?PHPSESSID=" . session_id() . "'>\n";
	//echo "<input type='hidden' name='internID' " . " value='$InternID'>\n";
	//echo "<input type='submit' name='submit' " . " value='View Available Opportunities'>\n";
	//echo "</form>\n";
	echo "<p><a href='AvailableOpportunities.php?" . SID . "'>View Available Opportunities</a></p>\n";
}
?>
