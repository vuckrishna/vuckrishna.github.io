...
$TableName = "staff"; // chamge table name
if ($errors == 0) {
...
if ($errors == 0) {
	...
	if ($qRes === FALSE) {
		...
		$_SESSION['staffID'] = $StaffID; // student id
	}
	mysqli_close($conn);
}
if ($errors == 0) {
	$StaffName = $first . " " . $last;
	$Body .= "<p>Thank you, $StaffName. ";
	$Body .= "Your new Student ID is <strong>" . $_SESSION['staffID'] . "</strong>.</p>\n"; // student id
}
